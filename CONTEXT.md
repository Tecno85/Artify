...
- Cobertura de autorización por rol, rechazo de roles no permitidos, propietario exacto en escrituras de autoservicio y cierres de sesión, sesiones ajenas tratadas como no disponibles, tokens firmados con encabezado y payload esperados, CRUD administrativo completo y contratos de los cuatro endpoints públicos de analytics, con filtros públicos normalizados a nombres reconocidos.
