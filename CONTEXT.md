...
- Resultado de pruebas automatizadas backend: 46/46 correctas.
...
- Cobertura de autorización por rol, rechazo de roles no permitidos, propietario exacto en escrituras de autoservicio, sesiones ajenas tratadas como no disponibles, CRUD administrativo completo y contratos de los cuatro endpoints públicos de analytics, con filtros públicos normalizados a nombres reconocidos.
