...
- Suite frontend con `node:test`: 27/27 correctas para autenticación temporal y recordada, redirección automática por rol, expiración de tokens, validación del registro público, sesión del editor, validación de imágenes, renderizado seguro y semántica accesible.
