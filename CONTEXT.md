...
- Suite frontend con `node:test`: 29/29 correctas para autenticación temporal y recordada, redirección automática por rol, expiración de tokens, validación del registro público, sesión del editor, validación de imágenes, renderizado seguro y semántica accesible.
