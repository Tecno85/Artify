...
- Resultado de pruebas automatizadas backend: 47/47 correctas.
...
- Cobertura de autorización por rol, rechazo de roles no permitidos, propietario exacto en escrituras de autoservicio y cierres de sesión, sesiones ajenas tratadas como no disponibles, CRUD administrativo completo y contratos de los cuatro endpoints públicos de analytics, con filtros públicos normalizados a nombres reconocidos.
- Validación previa de tamaño, megapíxeles y dimensiones antes de asignar una imagen al Canvas.
- Validación backend de cuerpos JSON no objeto, identificadores en consultas de actividad y metadatos de imagen con los límites de 10 MB, 16 MP y 8192 px del editor.
...
- [2026-08-03] Ampliación de pruebas frontend para comprobar que el registro valida contraseña, confirmación y aceptación de términos antes de consultar la API.
...
- [2026-08-03] Ampliación de pruebas backend puras para comprobar verificación de tokens firmados, rechazo de manipulación y expiración.
- [2026-08-03] Ampliación de pruebas frontend para comprobar que el editor elimina respaldos locales vencidos o alterados antes de recuperarlos.
- [2026-08-03] Ampliación de pruebas frontend para comprobar captura y restauración de foco en modales accesibles.
...
- [2026-08-06] Endurecimiento backend para rechazar metadatos de imagen que superen el límite de 16 MP del editor.
