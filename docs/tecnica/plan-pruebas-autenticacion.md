...
También ejecuto 37 pruebas frontend sin dependencias adicionales mediante:
...
Frontend: 37 pruebas ejecutadas y aprobadas
E2E: 7 pruebas ejecutadas y aprobadas
Total: 89 pruebas automatizadas aprobadas
0 pruebas fallidas
```
