...
También ejecuto 29 pruebas frontend sin dependencias adicionales mediante:
...
Estas pruebas comprueban el almacenamiento y la limpieza de sesión, la incorporación del token en solicitudes protegidas, la reacción ante respuestas `401`, la validación previa del login, la validación previa del registro público, la redirección según el rol, el inicio no bloqueante de la sesión de edición, las validaciones de imagen, el tratamiento seguro de contenido dinámico y la semántica accesible de modales y mensajes.
...
Frontend: 29 pruebas ejecutadas y aprobadas
E2E: 7 pruebas ejecutadas y aprobadas
Total: 66 pruebas automatizadas aprobadas
0 pruebas fallidas
```
