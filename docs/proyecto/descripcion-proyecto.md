...
- Sesenta pruebas automatizadas: 28 del backend para autenticación, sesiones, configuración, imágenes, analíticas, administración y seguridad HTTP; 26 del frontend para sesión, login por rol, inicio del editor, validaciones de imagen, contraste, renderizado seguro y accesibilidad básica; y 6 E2E en Chromium para flujos reales de autenticación, registro público, protección administrativa, sesión recordada y editor.
...
El proyecto se encuentra en estado activo y desplegado. Actualmente cuenta con frontend funcional en GitHub Pages, backend modularizado en Render, base de datos PostgreSQL en Neon, autenticación real, panel administrativo, 60 pruebas automatizadas entre backend, frontend y E2E en Chromium, y documentación organizada en:
