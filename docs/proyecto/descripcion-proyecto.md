...
- Setenta y una pruebas automatizadas: 32 del backend para autenticación, tokens firmados, sesiones, configuración, imágenes, analíticas, administración, limitación de intentos y seguridad HTTP; 32 del frontend para sesión, login por rol, registro público, autorización del panel administrativo, inicio del editor, respaldos locales, modales accesibles, validaciones de imagen, contraste, renderizado seguro y accesibilidad básica; y 7 E2E en Chromium para flujos reales de autenticación, registro público, autorización frontend, protección administrativa, sesión recordada y editor.
...
El proyecto se encuentra en estado activo y desplegado. Actualmente cuenta con frontend funcional en GitHub Pages, backend modularizado en Render, base de datos PostgreSQL en Neon, autenticación real, panel administrativo, 71 pruebas automatizadas entre backend, frontend y E2E en Chromium, y documentación organizada en:
